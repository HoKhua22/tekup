    ...
    <div class="home_containerServices">
      ...
      <div class="containerTab">
        <div class="tab">
          <div class="row tablinks" onclick="openCity(event, 'London')" id="defaultOpen">
            <div class="col-md-3 home_containerImagesTabs">
              <img class="home_imageTabs" src="<?php echo get_template_directory_uri() . '/images/home/fingerprint.png'; ?>" />
            </div>
        ...
        <div id="London" class="tabcontent">
          <div class="home_tabs">
            <img class="home_imageTabs" src="<?php echo get_template_directory_uri() . '/images/home/Rectangle.png'; ?>" />
          ...
          <div class="home_tabs">
            ...
            <div class="text-block">
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem provident architecto eligendi
                ...
                nulla, odio eum laborum cumque repudiandae.</p>
              <div class="frame">
                <button class="custom-btn btn-1"> <a class="home_textBTN" style="color: black;">TÌM HIỂU THÊM</a> <img class="" src="<?php echo get_template_directory_uri() . '/images/home/Vector.png'; ?>">
                </button>
              </div>
            </div>
          </div>
    ...
    <div class="container bbb">
      <div class="row counter_homeServices">
        ...
        <div class="col-md-3 counter-boxComAwards">
          ...
          <p class="titleCounterComAwards">Company Awards</p>
        </div>
      </div>
      <script>
